...
var DeviceInfoBox = function DeviceInfoBox(_ref) {
  var sampleRace = _ref.sampleRace;
  var _useState = useState([]),
    _useState2 = _slicedToArray(_useState, 2),
    broadcasts = _useState2[0],
    setBroadcasts = _useState2[1];
  ...
  var subscribeBroadcasts = useCallback(function () {
    var broadcastsQuery = query(collectionGroup(db, 'broadcasts'), where('idRace', '==', idRace), where('is_live', '==', true));
    var unsubscribe = onSnapshot(broadcastsQuery, /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(broadcastsSnapshot) {
        var broadcastsData, flattened;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              console.log('Broadcasts actualizados:', broadcastsSnapshot.docs.map(function (doc) {
                return _objectSpread({
                  id: doc.id
                }, doc.data());
              }));
              _context2.next = 3;
              return Promise.all(broadcastsSnapshot.docs.map(/*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(broadcastDoc) {
                  var broadcastData, broadcastId, broadcastPath, deviceInfoQuery, deviceInfoSnapshot, deviceInfoList;
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 8;
                        return onSnapshotPromise(deviceInfoQuery);
                      case 8:
                        deviceInfoSnapshot = _context.sent;
                        // Para cada registro de device_info, añadimos el campo "name" del broadcast
                        deviceInfoList = deviceInfoSnapshot.docs.map(function (doc) {
            ...
            case 3:
              broadcastsData = _context2.sent;
              setBroadcasts(broadcastsData);
              // Aplanamos todos los arrays de device_info en uno solo
              flattened = broadcastsData.flatMap(function (b) {
                return b.deviceInfo;
              });
  ...
  var onSnapshotPromise = function onSnapshotPromise(queryRef) {
    return new Promise(function (resolve) {
      var unsubscribe = onSnapshot(queryRef, function (snapshot) {
  ...
  return /*#__PURE__*/React.createElement("div", null, allDeviceInfo.length === 0 ? /*#__PURE__*/React.createElement("p", null, "No Race Data.") :
  /*#__PURE__*/
  // Se pasa el array combinado a BroadcastCard
  React.createElement(BroadcastCard, {
